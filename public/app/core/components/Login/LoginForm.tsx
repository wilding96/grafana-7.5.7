  ...
  return (
    <div className={wrapperStyles}>
      <Form onSubmit={onSubmit} validateOn="onChange">
        {({ register, errors }) => (
          <>
            <Field label="Email or username for wit" invalid={!!errors.user} error={errors.user?.message}>
              <Input
                autoFocus
                name="user"
                autoCapitalize="none"
            ...
            <Field label="Password for wit" invalid={!!errors.password} error={errors.password?.message}>
              <Input
                name="password"
                type="password"
